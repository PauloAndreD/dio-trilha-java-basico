...
public class ProcessoSeletivo {
  ...
  static void selecaoCandidatos() {
    ...
    while (cadidatosSelecionados < 5 && cadidatoAtual < candidatos.length) {
      String cadidato = candidatos[cadidatoAtual];
      double salarioPretendido = valorPretendido();

      System.out.println("O cadidato " + cadidato + " Solicitou este valor de Salario " + salarioPretendido);
      if (salarioBase >= salarioPretendido) {
        System.out.println("O cadidato " + cadidato + " foi selecionado para a vaga");
